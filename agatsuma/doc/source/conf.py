# -*- coding: utf-8 -*-
#
# Agatsuma documentation build configuration file, created by
...
project = u'Agatsuma'
copyright = u'2010, Fei Wong Reed'
...
latex_documents = [
  ('index', 'Agatsuma.tex', u'Agatsuma Documentation',
   u'Fei Wong Reed', 'manual'),
]
